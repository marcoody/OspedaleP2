...
//CHIRURGIA:
Paziente::Paziente(unsigned short id, std::string n, std::string c, const Medico * m, const data & dn, const gender & g, const data & ir, const data & fr, bool dec): Persona(id,n,c,dn,g), medicoAssegnato(m), inizioRicovero(ir),fineRicovero(fr), deceduto(dec) {};
